...
public class UsersLoggedinUsersByServiceMemory extends BaseTest {
	...
	@Test
	public void usersLoggedinUsersByServiceMemory()
		...
		users.selectSlientByActivity("By Service Memory (MB)");
