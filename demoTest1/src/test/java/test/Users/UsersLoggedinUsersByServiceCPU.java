...
public class UsersLoggedinUsersByServiceCPU extends BaseTest {
	...
	@Test
	public void usersLoggedinUsersByServiceCPU() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		users.selectSlientByActivity("By Service CPU (%)");
