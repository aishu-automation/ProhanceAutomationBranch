...
public class UsersLoggedinUsersByOperatingSystem extends BaseTest {
	...
	@Test
	public void usersLoggedinUsersByOperatingSystem()
		...
		users.selectSlientByActivity("By Operating System");
