...
public class UsersLoggedinUsersByProxy extends BaseTest{
	...
	@Test
	public void usersLoggedinUsersByProxy() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		users.selectSlientByActivity("By Proxy");
