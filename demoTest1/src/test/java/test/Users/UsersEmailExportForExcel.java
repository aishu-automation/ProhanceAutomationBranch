...
public class UsersEmailExportForExcel extends BaseTest{
	...
	@Test
	public void usersEmailExcelExport() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		Thread.sleep(30000);
		listeners.testStepDescription("Step 10: Verify Mail sended success message");
		users.getMailSuccessMsg();
		listeners.testStepDescription("Step 11: Open the mail in new tab");
		...
		listeners.testStepDescription("Step 12: Enter the UserName");
		users.sendoutlookUserName("aishwarya.k@prohance.net");
		listeners.testStepDescription("Step 13: Click on NEXT button");
		users.clickNextBtn();
		listeners.testStepDescription("Step 14: Enter the Password");
		users.sendoutlookPassword("AishProh@03");
		Thread.sleep(1000);
		listeners.testStepDescription("Step 15: Click on Sign In button");
		users.clickSignInBtn();
		Thread.sleep(1000);
		listeners.testStepDescription("Step 16: Click on Stay SignIn button");
		users.clickStaySignInBtn();
		Thread.sleep(1000);
		listeners.testStepDescription("Step 17: Click on recently sended mail to open ");
		users.clickExexcel();
		listeners.testStepDescription("Step 18: Click on Switch tab");
