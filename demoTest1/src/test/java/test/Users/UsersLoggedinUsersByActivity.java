...
public class UsersLoggedinUsersByActivity extends BaseTest {
	...
	public void usersLoggedinUsersByHeartbeat() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		{
		  //listeners.testStepDescription("Step 14: Click on Count");
		  users.clickCount();
		  //listeners.testStepDescription("Step 15: Get the lists from web");
		  ...
		  //listeners.testStepDescription("Step 18: Compare the web and excel list are equal");
		  boolean check =hostNameList.equals(hostNameExcelList);
		  //System.out.println(check); 
		  Assert.assertTrue(check);
		  //listeners.testStepDescription("Step 19: Click on Pdf export to download");
		  users.clickbyHeartbeatPdf(); 
		  //listeners.testStepDescription("Step 20: Compare the web and pdf list are equal");
