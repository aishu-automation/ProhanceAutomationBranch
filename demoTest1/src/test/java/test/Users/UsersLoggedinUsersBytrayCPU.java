...
public class UsersLoggedinUsersBytrayCPU extends BaseTest{
	...
	@Test
	public void usersLoggedinUsersByTrayCPU () throws InterruptedException, EncryptedDocumentException, IOException {
		...
		users.selectSlientByActivity("By Tray CPU (%)");
